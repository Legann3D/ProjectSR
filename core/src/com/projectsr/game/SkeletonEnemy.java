...
public class SkeletonEnemy extends Enemy {
    ...
    public void create() {
        ...
        Texture walkSheet = assetManager.get("Walk.png", Texture.class);
        ...
        deathFrames[0] = new TextureRegion(deathSheet,150,0,150,150);
        deathFrames[0] = new TextureRegion(deathSheet,300,0,150,150);
        deathFrames[0] = new TextureRegion(deathSheet,450,0,150,150);
    }
